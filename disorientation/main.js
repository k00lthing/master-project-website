...
const axisInputX = document.querySelector("#demo-axis-x");
const axisInputY = document.querySelector("#demo-axis-y");
...
axisInputX.addEventListener("change", (event) => {
    root.style.setProperty('--disorientation-font-axis-x', event.target.value);

});

axisInputY.addEventListener("change", (event) => {
    root.style.setProperty('--disorientation-font-axis-y', event.target.value);
...
form.onreset = () => {
    ...
    root.style.setProperty('--disorientation-font-axis-x', 0);
    root.style.setProperty('--disorientation-font-axis-y', 0);
